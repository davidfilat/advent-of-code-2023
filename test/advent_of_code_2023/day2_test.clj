...
(deftest test-parse-round
  (testing "Parsing a round of game"
    (is (= (parse-round "10 green, 5 blue")
           {"green" 10, "blue" 5}))
...
(deftest test-parse-game-data
  (testing "Parsing game data"
    (is (= (parse-game-data "Game 1: 10 green, 5 blue; 1 red, 9 green, 10 blue")
           {:game-number 1
            :rounds      [{"green" 10, "blue" 5} {"red" 1, "green" 9, "blue" 10}]}))))
...
(deftest test-all-keys-greater?
  (testing "Testing if all keys in one map are greater than the corresponding keys in another map"
...
(deftest test-solution-part-1
  (with-redefs [util/read-input-file (fn [_] ["Game 1: 10 green, 5 blue; 1 red, 9 green, 10 blue"
